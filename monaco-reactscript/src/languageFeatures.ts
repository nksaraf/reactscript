...
// / <reference types="./lib/typescriptServices.d.ts" />
...
export abstract class Adapter {
	...
	constructor(protected _worker: (first: Uri, ...more: Uri[]) => Promise<ReactScriptWorker>) {
	}
...
export class DiagnosticsAdapter extends Adapter {
	...
	constructor(private _defaults: LanguageServiceDefaultsImpl, private _selector: string,
		worker: (first: Uri, ...more: Uri[]) => Promise<ReactScriptWorker>
	) {
		super(worker);

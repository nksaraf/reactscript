...
function getTemplate(_a, modules) {
    var _b = _a.dependencies, dependencies = _b === void 0 ? {} : _b, _c = _a.devDependencies, devDependencies = _c === void 0 ? {} : _c;
    ...
    var nodeDeps = ["express", "koa", "nodemon", "ts-node"];
...
function useDebouncedCallback(callback, delay, deps) {
  ...
  var maxWaitHandler = (0, hooks_module.useRef)(null);
  var maxWaitArgs = (0, hooks_module.useRef)([]);
  var functionTimeoutHandler = (0, hooks_module.useRef)(null);
  var isComponentUnmounted = (0, hooks_module.useRef)(false);
  var debouncedFunction = (0, hooks_module.useCallback)(callback, deps);
  var cancelDebouncedCallback = (0, hooks_module.useCallback)(function () {
...
var callback$1 = unwrapExports(callback);

export { acornJsx, templates_1 as getMainFile, templates_2 as getTemplate, lodash_isequal as isEqual, callback$1 as useDebouncedCallback, version };
//# sourceMappingURL=codesandbox-utils.js.map
